...
void SPISendBytes(u8 *data, u8 size, GPIO_TypeDef* GPIOx, u16 GPIO_Pin );
void SPISendReadBytes(u8 *txdata, u8 txsize, u8 rxsize, GPIO_TypeDef* GPIOx, u16 GPIO_Pin);
...
void selectSlave(GPIO_TypeDef* GPIOx, u16 GPIO_Pin) {
...
void deselectSlave(GPIO_TypeDef* GPIOx, u16 GPIO_Pin) {
