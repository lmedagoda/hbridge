...
uint32_t statistic1 = 0;
uint32_t statistic2 = 0;
uint32_t statistic_tr = 0;
uint32_t statistic_nr = 0;
uint32_t statistic_gt = 0;
uint32_t statistic_r = 0;

uint8_t lm73cimk_triggerTemeratureConversion(enum LM73_SENSORS sensor);
void moveLM73CIMKStateMachine(enum LM73_SENSORS sensor);
uint8_t lm73cimk_requestTemperature(enum LM73_SENSORS sensor);
