/* 
 * Copyright (c) 2007 emtrion GmbH - All rights reserved.
 *
 * $Id: hico_api.h 1052 2008-07-04 12:08:09Z ny $
...
/* HiCO.CAN-PCI-104 High Speed */
#define HW_HICOCAN_PCI104_HS 0x11
/* HiCO.CAN-PCI-104 Fault Tolerant */
#define HW_HICOCAN_PCI104_FT 0x12
...
#ifdef __KERNEL__
 /* Comment this out, since it will be removed from future versions */
 #define HAVE_IOC_SET_MODE
#endif

#ifdef HAVE_IOC_SET_MODE
/**************************************************************************/
#define IOC_SET_MODE                          _IOW (IOC_MAGIC, 65, uint32_t)
/**************************************************************************/
#warning IOC_SET_MODE is deprecated. Use commands IOC_START/STOP/PASSIVE/START_BAUDSCAN instead!
#endif
